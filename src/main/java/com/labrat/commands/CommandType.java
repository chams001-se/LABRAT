...
public enum CommandType {
    ...
    INVENTORY("{i o/inventory open}", "Opens the inventory menu to focus on items in the player's inventory."),
    CLOSEINVENTORY("{i c/inventory close}", "Closes the inventory."),
