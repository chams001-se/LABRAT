...
public class RoomsCreator {
    ...
    public RoomsCreator() {
        ...
        rooms.add(new RoomBuilder()
                .withDescription("")
                .withDescriptionColor(PrinterColor.DEFAULT)
                .build()
        );
        ...
        // Set Items
        rooms.get(1).addItem(new Note("You pick up the 'helloworld' note in your hand.\n'The password is FOOBAR.'", PrinterColor.CYAN, "helloworld"));
    }
